module 0x1::primary_fungible_store {
    ...
    public fun deposit(arg0: address, arg1: 0x1::fungible_asset::FungibleAsset) acquires DeriveRefPod {
        ...
        0x1::dispatchable_fungible_asset::deposit<0x1::fungible_asset::FungibleStore>(v1, arg1);
    }
    ...
    public entry fun transfer<T0: key>(arg0: &signer, arg1: 0x1::object::Object<T0>, arg2: address, arg3: u64) acquires DeriveRefPod {
        ...
        0x1::dispatchable_fungible_asset::transfer<0x1::fungible_asset::FungibleStore>(arg0, v0, v1, arg3);
    }

    public entry fun transfer_assert_minimum_deposit<T0: key>(arg0: &signer, arg1: 0x1::object::Object<T0>, arg2: address, arg3: u64, arg4: u64) acquires DeriveRefPod {
        let v0 = ensure_primary_store_exists<T0>(0x1::signer::address_of(arg0), arg1);
        may_be_unburn(arg0, v0);
        let v1 = ensure_primary_store_exists<T0>(arg2, arg1);
        0x1::dispatchable_fungible_asset::transfer_assert_minimum_deposit<0x1::fungible_asset::FungibleStore>(arg0, v0, v1, arg3, arg4);
    }

    public fun withdraw<T0: key>(arg0: &signer, arg1: 0x1::object::Object<T0>, arg2: u64) : 0x1::fungible_asset::FungibleAsset acquires DeriveRefPod {
        let v0 = ensure_primary_store_exists<T0>(0x1::signer::address_of(arg0), arg1);
        may_be_unburn(arg0, v0);
        0x1::dispatchable_fungible_asset::withdraw<0x1::fungible_asset::FungibleStore>(arg0, v0, arg2)
    }
    ...
    public fun is_balance_at_least<T0: key>(arg0: address, arg1: 0x1::object::Object<T0>, arg2: u64) : bool {
        let v0 = primary_store_exists<T0>(arg0, arg1);
        v0 && 0x1::fungible_asset::is_balance_at_least<0x1::fungible_asset::FungibleStore>(primary_store<T0>(arg0, arg1), arg2) || arg2 == 0
    }
    ...
    public fun ensure_primary_store_exists<T0: key>(arg0: address, arg1: 0x1::object::Object<T0>) : 0x1::object::Object<0x1::fungible_asset::FungibleStore> acquires DeriveRefPod {
        ...
        if (0x1::fungible_asset::store_exists(v0)) {
    ...
    public(friend) fun force_deposit(arg0: address, arg1: 0x1::fungible_asset::FungibleAsset) acquires DeriveRefPod {
        let v0 = 0x1::fungible_asset::asset_metadata(&arg1);
        let v1 = ensure_primary_store_exists<0x1::fungible_asset::Metadata>(arg0, v0);
        let v2 = 0x1::object::object_address<0x1::fungible_asset::FungibleStore>(&v1);
        0x1::fungible_asset::deposit_internal(v2, arg1);
    }
