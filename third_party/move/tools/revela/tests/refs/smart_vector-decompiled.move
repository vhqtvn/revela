module 0x1::smart_vector {
    ...
    public fun index_of<T0>(arg0: &SmartVector<T0>, arg1: &T0) : (bool, u64) {
        ...
        if (v0) {
            (true, v1)
        } else if (0x1::option::is_some<0x1::big_vector::BigVector<T0>>(&arg0.big_vec)) {
    ...
    public fun reverse<T0: store>(arg0: &mut SmartVector<T0>) {
        ...
        loop {
            ...
            0x1::vector::push_back<T0>(&mut v4, 0x1::vector::pop_back<T0>(&mut arg0.inline_vec));
        };
        0x1::vector::reverse<T0>(&mut v4);
        loop {
        ...
        0x1::vector::destroy_empty<T0>(v0);
        loop {
            if (0x1::vector::is_empty<T0>(&mut v4)) {
                break
            };
            push_back<T0>(arg0, 0x1::vector::pop_back<T0>(&mut v4));
        };
    ...
    public fun add_all<T0: store>(arg0: &mut SmartVector<T0>, arg1: vector<T0>) {
        ...
        while (v0 > 0) {
            push_back<T0>(arg0, 0x1::vector::pop_back<T0>(&mut arg1));
            v0 = v0 - 1;
        };
