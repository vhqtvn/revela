module 0x1::multisig_account {
    ...
    public fun can_be_executed(arg0: address, arg1: u64) : bool acquires MultisigAccount {
        ...
        let v1 = arg1 > 0 && arg1 < v0.next_sequence_number;
        assert!(v1, 0x1::error::invalid_argument(17));
        let v2 = borrow_global<MultisigAccount>(arg0);
        let v3 = &v2.owners;
        let v4 = 0;
        let v5 = 0;
        let v6 = &0x1::table::borrow<u64, MultisigTransaction>(&v2.transactions, arg1).votes;
        let v7 = 0;
        while (v7 < 0x1::vector::length<address>(v3)) {
            let v8 = 0x1::vector::borrow<address>(v3, v7);
            if (0x1::simple_map::contains_key<address, bool>(v6, v8)) {
                if (*0x1::simple_map::borrow<address, bool>(v6, v8)) {
                    v5 = v5 + 1;
                } else {
                    v4 = v4 + 1;
                };
        ...
        let v9 = last_resolved_sequence_number(arg0);
        if (arg1 == v9 + 1) {
    ...
    public fun can_execute(arg0: address, arg1: address, arg2: u64) : bool acquires MultisigAccount {
        ...
        let v1 = arg2 > 0 && arg2 < v0.next_sequence_number;
        assert!(v1, 0x1::error::invalid_argument(17));
        let v2 = borrow_global<MultisigAccount>(arg1);
        let v3 = &v2.owners;
        let v4 = 0;
        let v5 = 0;
        let v6 = &0x1::table::borrow<u64, MultisigTransaction>(&v2.transactions, arg2).votes;
        let v7 = 0;
        while (v7 < 0x1::vector::length<address>(v3)) {
            let v8 = 0x1::vector::borrow<address>(v3, v7);
            if (0x1::simple_map::contains_key<address, bool>(v6, v8)) {
        ...
        if (is_owner(arg0, arg1)) {
            let v11 = last_resolved_sequence_number(arg1);
            v1 = arg2 == v11 + 1;
        } else {
            v1 = false;
        };
        if (v1) {
            let v12 = num_signatures_required(arg1);
            v1 = v5 >= v12;
        } else {
            v1 = false;
        };
    ...
    fun create_with_owners_internal(arg0: &signer, arg1: vector<address>, arg2: u64, arg3: 0x1::option::Option<0x1::account::SignerCapability>, arg4: vector<0x1::string::String>, arg5: vector<vector<u8>>) acquires MultisigAccount {
        ...
        let v0 = 0x1::table::new<u64, MultisigTransaction>();
        let v1 = 0x1::simple_map::create<0x1::string::String, vector<u8>>();
        let v2 = 0x1::account::new_event_handle<AddOwnersEvent>(arg0);
        let v3 = 0x1::account::new_event_handle<RemoveOwnersEvent>(arg0);
        let v4 = 0x1::account::new_event_handle<UpdateSignaturesRequiredEvent>(arg0);
        let v5 = 0x1::account::new_event_handle<CreateTransactionEvent>(arg0);
        let v6 = 0x1::account::new_event_handle<VoteEvent>(arg0);
        let v7 = 0x1::account::new_event_handle<ExecuteRejectedTransactionEvent>(arg0);
        let v8 = 0x1::account::new_event_handle<TransactionExecutionSucceededEvent>(arg0);
        let v9 = 0x1::account::new_event_handle<TransactionExecutionFailedEvent>(arg0);
        let v10 = 0x1::account::new_event_handle<MetadataUpdatedEvent>(arg0);
        let v11 = MultisigAccount{
            owners                              : arg1,
            num_signatures_required             : arg2,
            transactions                        : v0,
            ...
            signer_cap                          : arg3,
            metadata                            : v1,
            add_owners_events                   : v2,
            remove_owners_events                : v3,
            update_signature_required_events    : v4,
            create_transaction_events           : v5,
            vote_events                         : v6,
            execute_rejected_transaction_events : v7,
            execute_transaction_events          : v8,
            transaction_execution_failed_events : v9,
            metadata_updated_events             : v10,
        };
        move_to<MultisigAccount>(arg0, v11);
    ...
    fun validate_multisig_transaction(arg0: &signer, arg1: address, arg2: vector<u8>) acquires MultisigAccount {
        ...
        let v9 = v8 && 0x1::option::is_some<vector<u8>>(&v6.payload);
        if (v9) {
    ...
    public fun vote(arg0: address, arg1: u64, arg2: address) : (bool, bool) acquires MultisigAccount {
        ...
        let v2 = 0x1::simple_map::contains_key<address, bool>(v1, &arg2);
        let v3 = v2 && *0x1::simple_map::borrow<address, bool>(v1, &arg2);
        (v2, v3)
    }
