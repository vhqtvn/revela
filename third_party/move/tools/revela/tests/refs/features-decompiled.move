module 0x1::features {
    ...
    fun apply_diff(arg0: &mut vector<u8>, arg1: vector<u64>, arg2: vector<u64>) {
        ...
        while (v0 > 0) {
            set(arg0, 0x1::vector::pop_back<u64>(&mut arg1), true);
            v0 = v0 - 1;
        };
        0x1::vector::destroy_empty<u64>(arg1);
        0x1::vector::reverse<u64>(&mut arg2);
        v0 = 0x1::vector::length<u64>(&arg2);
        while (v0 > 0) {
            set(arg0, 0x1::vector::pop_back<u64>(&mut arg2), false);
            v0 = v0 - 1;
        };
    ...
    public fun change_feature_flags_for_next_epoch(arg0: &signer, arg1: vector<u64>, arg2: vector<u64>) acquires Features, PendingFeatures {
        ...
        let v0 = if (exists<PendingFeatures>(@0x1)) {
            ...
            v0
        } else if (exists<Features>(@0x1)) {
            borrow_global<Features>(@0x1).features
        } else {
            0x1::vector::empty<u8>()
        };
        let v1 = &mut v0;
        apply_diff(v1, arg1, arg2);
        let v2 = PendingFeatures{features: v0};
    ...
    fun change_feature_flags_internal(arg0: &signer, arg1: vector<u64>, arg2: vector<u64>) acquires Features {
        ...
        while (v3 < 0x1::vector::length<u64>(v4)) {
            set(v1, *0x1::vector::borrow<u64>(v4, v3), false);
            v3 = v3 + 1;
        };
    }
