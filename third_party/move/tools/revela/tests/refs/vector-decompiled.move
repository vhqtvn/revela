module 0x1::vector {
    ...
    public fun remove_value<T0>(arg0: &mut vector<T0>, arg1: &T0) : vector<T0> {
        ...
        if (v0) {
            let v3 = empty<T0>();
            let v4 = &mut v3;
            push_back<T0>(v4, remove<T0>(arg0, v1));
            v3
        } else {
            empty<T0>()
        }
    ...
    public fun reverse_append<T0>(arg0: &mut vector<T0>, arg1: vector<T0>) {
        ...
        while (v0 > 0) {
            let v1 = &mut arg1;
            push_back<T0>(arg0, pop_back<T0>(v1));
            v0 = v0 - 1;
        };
    ...
    public fun rotate<T0>(arg0: &mut vector<T0>, arg1: u64) : u64 {
        let v0 = length<T0>(arg0);
        rotate_slice<T0>(arg0, 0, arg1, v0)
    }
    ...
    public fun slice<T0: copy>(arg0: &vector<T0>, arg1: u64, arg2: u64) : vector<T0> {
        ...
        while (arg1 < arg2) {
            let v1 = &mut v0;
            push_back<T0>(v1, *borrow<T0>(arg0, arg1));
            arg1 = arg1 + 1;
        };
        v0
    }
    ...
    public fun trim_reverse<T0>(arg0: &mut vector<T0>, arg1: u64) : vector<T0> {
        ...
        while (arg1 < v0) {
            let v2 = &mut v1;
            push_back<T0>(v2, pop_back<T0>(arg0));
            v0 = v0 - 1;
        };
        v1
    }
