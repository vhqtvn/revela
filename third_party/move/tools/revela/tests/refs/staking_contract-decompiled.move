module 0x1::staking_contract {
    ...
    public fun create_staking_contract_with_coins(arg0: &signer, arg1: address, arg2: address, arg3: 0x1::coin::Coin<0x1::aptos_coin::AptosCoin>, arg4: u64, arg5: vector<u8>) : address acquires Store {
        ...
        if (0x1::simple_map::contains_key<address, StakingContract>(v6, &arg1)) {
    ...
    public entry fun distribute(arg0: address, arg1: address) acquires BeneficiaryForOperator, Store {
        ...
        let v2 = &mut v0.distribute_events;
        distribute_internal(arg0, arg1, v1, v2);
    }
    ...
    public entry fun request_commission(arg0: &signer, arg1: address, arg2: address) acquires BeneficiaryForOperator, Store {
        ...
        let v5 = &mut v3.distribute_events;
        distribute_internal(arg1, arg2, v4, v5);
        let v6 = &mut v3.add_distribution_events;
        let v7 = &mut v3.request_commission_events;
        request_commission_internal(arg2, v4, v6, v7);
    }
    ...
    public fun staking_contract_exists(arg0: address, arg1: address) : bool acquires Store {
        if (exists<Store>(arg0)) {
            let v0 = &borrow_global<Store>(arg0).staking_contracts;
            return 0x1::simple_map::contains_key<address, StakingContract>(v0, &arg1)
        };
        false
    }
    ...
    public entry fun switch_operator(arg0: &signer, arg1: address, arg2: address, arg3: u64) acquires BeneficiaryForOperator, Store {
        ...
        if (0x1::simple_map::contains_key<address, StakingContract>(v2, &arg2)) {
            abort 0x1::error::invalid_state(5)
        };
        let (_, v4) = 0x1::simple_map::remove<address, StakingContract>(v2, &arg1);
        let v5 = v4;
        let v6 = &mut v5;
        let v7 = &mut v1.distribute_events;
        distribute_internal(v0, arg1, v6, v7);
        let v8 = &mut v5;
        let v9 = &mut v1.add_distribution_events;
        let v10 = &mut v1.request_commission_events;
        request_commission_internal(arg1, v8, v9, v10);
        0x1::stake::set_operator_with_cap(&v5.owner_cap, arg2);
        v5.commission_percentage = arg3;
        let v11 = v5.pool_address;
        0x1::simple_map::add<address, StakingContract>(v2, arg2, v5);
        if (0x1::features::module_event_migration_enabled()) {
            let v12 = SwitchOperator{
                old_operator : arg1,
                new_operator : arg2,
                pool_address : v11,
            };
            0x1::event::emit<SwitchOperator>(v12);
        };
        let v13 = SwitchOperatorEvent{
            old_operator : arg1,
            new_operator : arg2,
            pool_address : v11,
        };
        0x1::event::emit_event<SwitchOperatorEvent>(&mut v1.switch_operator_events, v13);
    }
    ...
    public entry fun unlock_stake(arg0: &signer, arg1: address, arg2: u64) acquires BeneficiaryForOperator, Store {
        ...
        let v1 = borrow_global_mut<Store>(v0);
        let v2 = 0x1::simple_map::borrow_mut<address, StakingContract>(&mut v1.staking_contracts, &arg1);
        let v3 = &mut v1.distribute_events;
        distribute_internal(v0, arg1, v2, v3);
        let v4 = &mut v1.add_distribution_events;
        let v5 = &mut v1.request_commission_events;
        let v6 = request_commission_internal(arg1, v2, v4, v5);
        let (v7, _, _, _) = 0x1::stake::get_stake(v2.pool_address);
        if (v7 < arg2) {
            arg2 = v7;
        };
        v2.principal = v2.principal - arg2;
        let v11 = &mut v1.add_distribution_events;
        add_distribution(arg1, v2, v0, arg2, v11);
        0x1::stake::unlock_with_cap(arg2, &v2.owner_cap);
        let v12 = v2.pool_address;
        if (0x1::features::module_event_migration_enabled()) {
            let v13 = UnlockStake{
                operator        : arg1,
                pool_address    : v12,
            ...
            0x1::event::emit<UnlockStake>(v13);
        };
        let v14 = UnlockStakeEvent{
            operator        : arg1,
            pool_address    : v12,
            amount          : arg2,
            commission_paid : v6,
        };
        0x1::event::emit_event<UnlockStakeEvent>(&mut v1.unlock_stake_events, v14);
    }
    ...
    public entry fun update_commision(arg0: &signer, arg1: address, arg2: u64) acquires BeneficiaryForOperator, StakingGroupUpdateCommissionEvent, Store {
        ...
        let v4 = &mut v1.add_distribution_events;
        let v5 = &mut v1.request_commission_events;
        request_commission_internal(arg1, v2, v4, v5);
        let v6 = v2.commission_percentage;
        v2.commission_percentage = arg2;
        if (!exists<StakingGroupUpdateCommissionEvent>(v0)) {
            let v7 = 0x1::account::new_event_handle<UpdateCommissionEvent>(arg0);
            let v8 = StakingGroupUpdateCommissionEvent{update_commission_events: v7};
            move_to<StakingGroupUpdateCommissionEvent>(arg0, v8);
        };
        if (0x1::features::module_event_migration_enabled()) {
            let v9 = UpdateCommission{
                staker                    : v0,
                operator                  : arg1,
                old_commission_percentage : v6,
                new_commission_percentage : arg2,
            };
            0x1::event::emit<UpdateCommission>(v9);
        };
        let v10 = &mut borrow_global_mut<StakingGroupUpdateCommissionEvent>(v0).update_commission_events;
        let v11 = UpdateCommissionEvent{
            staker                    : v0,
            operator                  : arg1,
            old_commission_percentage : v6,
            new_commission_percentage : arg2,
        };
        0x1::event::emit_event<UpdateCommissionEvent>(v10, v11);
    }
