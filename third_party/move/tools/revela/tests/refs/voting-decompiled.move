module 0x1::voting {
    ...
    public fun create_proposal_v2<T0: store>(arg0: address, arg1: address, arg2: T0, arg3: vector<u8>, arg4: u128, arg5: u64, arg6: 0x1::option::Option<u128>, arg7: 0x1::simple_map::SimpleMap<0x1::string::String, vector<u8>>, arg8: bool) : u64 acquires VotingForum {
        ...
        } else if (0x1::simple_map::contains_key<0x1::string::String, vector<u8>>(&mut arg7, &v2)) {
            0x1::simple_map::remove<0x1::string::String, vector<u8>>(&mut arg7, &v2);
        };
        let v4 = 0x1::timestamp::now_seconds();
        let v5 = 0x1::option::some<T0>(arg2);
        let v6 = Proposal<T0>{
            proposer                        : arg0,
            execution_content               : v5,
            metadata                        : arg7,
            creation_time_secs              : v4,
            execution_hash                  : arg3,
        ...
        0x1::table::add<u64, Proposal<T0>>(&mut v0.proposals, v1, v6);
        if (0x1::features::module_event_migration_enabled()) {
            let v7 = CreateProposal{
                proposal_id                     : v1,
                early_resolution_vote_threshold : arg6,
                execution_hash                  : arg3,
                expiration_secs                 : arg5,
            ...
            0x1::event::emit<CreateProposal>(v7);
        };
        ...
        0x1::event::emit_event<CreateProposalEvent>(&mut v0.events.create_proposal_events, v8);
        v1
    }
