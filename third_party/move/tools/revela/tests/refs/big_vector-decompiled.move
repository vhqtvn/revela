module 0x1::big_vector {
    ...
    public fun remove<T0>(arg0: &mut BigVector<T0>, arg1: u64) : T0 {
        ...
        let v2 = 0x1::table_with_length::borrow_mut<u64, vector<T0>>(&mut arg0.buckets, v1 - 1);
        arg0.end_index = arg0.end_index - 1;
        while (v1 < v0) {
            let v3 = &mut arg0.buckets;
            let v4 = 0x1::vector::remove<T0>(0x1::table_with_length::borrow_mut<u64, vector<T0>>(v3, v1), 0);
            let v5 = 0x1::table_with_length::borrow_mut<u64, vector<T0>>(&mut arg0.buckets, v1 - 1);
            0x1::vector::push_back<T0>(v5, v4);
            v1 = v1 + 1;
        };
        let v6 = 0x1::table_with_length::borrow_mut<u64, vector<T0>>(&mut arg0.buckets, v0 - 1);
        if (0x1::vector::is_empty<T0>(v6)) {
            let v7 = 0x1::table_with_length::remove<u64, vector<T0>>(&mut arg0.buckets, v0 - 1);
            0x1::vector::destroy_empty<T0>(v7);
        };
        0x1::vector::remove<T0>(v2, arg1 % arg0.bucket_size)
    }
