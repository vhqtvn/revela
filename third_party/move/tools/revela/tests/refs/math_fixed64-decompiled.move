module 0x1::math_fixed64 {
    ...
    fun exp_raw(arg0: u256) : u256 {
        ...
        let v3 = v2 / 22045359733108027;
        let v4 = v2 % 22045359733108027;
        let v5 = pow_raw(18468802611690918839, (v3 as u128));
        let v6 = v5 - (v5 * 219071715585908898 * v3 >> 128);
        let v7 = v6 * v4 >> 64 - v1;
        let v8 = v7 * v4 >> 64;
        let v9 = v8 * v4 >> 64;
        let v10 = v9 * v4 >> 64;
        let v11 = v10 * v4 >> 64;
        (v6 << v1) + v7 + v8 / 2 + v9 / 6 + v10 / 24 + v11 / 120 + (v11 * v4 >> 64) / 720
    }
    ...
    public fun log2_plus_64(arg0: 0x1::fixed_point64::FixedPoint64) : 0x1::fixed_point64::FixedPoint64 {
        0x1::math128::log2_64(0x1::fixed_point64::get_raw_value(arg0))
    }
