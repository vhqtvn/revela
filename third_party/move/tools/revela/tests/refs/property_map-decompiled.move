module 0x1337::property_map {
    ...
    public fun create_property_value<T0: copy>(arg0: &T0) : PropertyValue {
        ...
        let v1 = v0 == 0x1::string::utf8(b"bool") || v0 == 0x1::string::utf8(b"u8");
        if (v1) {
            v1 = true;
        } else {
            v1 = v0 == 0x1::string::utf8(b"u64");
        };
        if (v1) {
            v1 = true;
        } else {
            v1 = v0 == 0x1::string::utf8(b"u128");
        };
        if (v1) {
            v1 = true;
        } else {
            v1 = v0 == 0x1::string::utf8(b"address");
        };
        if (v1) {
            v1 = true;
        } else {
            v1 = v0 == 0x1::string::utf8(b"0x1::string::String");
        };
        if (v1) {
    ...
    public fun new_with_key_and_property_value(arg0: vector<0x1::string::String>, arg1: vector<PropertyValue>) : PropertyMap {
        ...
        while (v2 < v0) {
            ...
            assert!(0x1::string::length(&v3) <= 128, 0x1::error::invalid_argument(7));
            let v4 = &mut v1;
            add(v4, v3, *0x1::vector::borrow<PropertyValue>(&arg1, v2));
            v2 = v2 + 1;
        };
        v1
    }
