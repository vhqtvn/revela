module 0x1::delegation_pool {
    ...
    public entry fun reactivate_stake(arg0: &signer, arg1: address, arg2: u64) acquires BeneficiaryForOperator, DelegationPool, DelegationPoolAllowlisting, GovernanceRecords, NextCommissionPercentage {
        ...
        let v3 = v1.observed_lockup_cycle;
        let v4 = redeem_inactive_shares(v1, v0, v2, v3);
        let v5 = retrieve_stake_pool_owner(v1);
        0x1::stake::reactivate_stake(&v5, v4);
        buy_in_active_shares(v1, v0, v4);
        assert_min_active_balance(v1, v0);
        if (0x1::features::module_event_migration_enabled()) {
            let v6 = ReactivateStake{
                pool_address       : arg1,
                delegator_address  : v0,
                amount_reactivated : v4,
            };
            0x1::event::emit<ReactivateStake>(v6);
        };
        let v7 = ReactivateStakeEvent{
            pool_address       : arg1,
            delegator_address  : v0,
            amount_reactivated : v4,
        };
        0x1::event::emit_event<ReactivateStakeEvent>(&mut v1.reactivate_stake_events, v7);
    }
    ...
    public entry fun withdraw(arg0: &signer, arg1: address, arg2: u64) acquires BeneficiaryForOperator, DelegationPool, GovernanceRecords, NextCommissionPercentage {
        ...
        withdraw_internal(v0, 0x1::signer::address_of(arg0), arg2);
    }
    ...
    fun buy_in_pending_inactive_shares(arg0: &mut DelegationPool, arg1: address, arg2: u64) : u128 acquires GovernanceRecords {
        ...
        let v2 = pending_inactive_shares_pool_mut(arg0);
        0x1::pool_u64_unbound::buy_in(v2, arg1, arg2);
        execute_pending_withdrawal(arg0, arg1);
        let v3 = arg0.observed_lockup_cycle;
        let v4 = &mut arg0.pending_withdrawals;
        let v5 = 0x1::table::borrow_mut_with_default<address, ObservedLockupCycle>(v4, arg1, v3);
        assert!(*v5 == v3, 0x1::error::invalid_state(4));
        v0
    }
    ...
    public fun calculate_and_update_voter_total_voting_power(arg0: address, arg1: address) : u64 acquires BeneficiaryForOperator, DelegationPool, GovernanceRecords, NextCommissionPercentage {
        ...
        let v0 = borrow_global<DelegationPool>(arg0);
        let v1 = borrow_global_mut<GovernanceRecords>(arg0);
        calculate_total_voting_power(v0, update_and_borrow_mut_delegated_votes(v0, v1, arg1))
    }
    ...
    public entry fun create_proposal(arg0: &signer, arg1: address, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: bool) acquires BeneficiaryForOperator, DelegationPool, GovernanceRecords, NextCommissionPercentage {
        ...
        synchronize_delegation_pool(arg1);
        let v0 = 0x1::signer::address_of(arg0);
        let v1 = borrow_global_mut<GovernanceRecords>(arg1);
        let v2 = 0x1::aptos_governance::get_required_proposer_stake();
        let v3 = calculate_and_update_delegated_votes(borrow_global<DelegationPool>(arg1), v1, v0) >= v2;
    ...
    fun redeem_inactive_shares(arg0: &mut DelegationPool, arg1: address, arg2: u64, arg3: ObservedLockupCycle) : u64 acquires GovernanceRecords {
        ...
        let v3 = partial_governance_voting_enabled(v2) && arg3.index == arg0.observed_lockup_cycle.index;
        if (v3) {
            update_governanace_records_for_redeem_pending_inactive_shares(arg0, v2, v1, arg1);
        };
        let v4 = &mut arg0.inactive_shares;
        let v5 = 0x1::table::borrow_mut<ObservedLockupCycle, 0x1::pool_u64_unbound::Pool>(v4, arg3);
        if (0x1::pool_u64_unbound::shares(v5, arg1) == 0) {
        ...
        if (arg3.index < arg0.observed_lockup_cycle.index) {
            v3 = 0x1::pool_u64_unbound::total_coins(v5) == 0;
        } else {
            v3 = false;
        };
        if (v3) {
            let v6 = &mut arg0.inactive_shares;
            let v7 = 0x1::table::remove<ObservedLockupCycle, 0x1::pool_u64_unbound::Pool>(v6, arg3);
            0x1::pool_u64_unbound::destroy_empty(v7);
        };
        0x1::pool_u64_unbound::redeem_shares(v5, arg1, v1)
    }
    ...
    public entry fun synchronize_delegation_pool(arg0: address) acquires BeneficiaryForOperator, DelegationPool, GovernanceRecords, NextCommissionPercentage {
        ...
        let v10 = pending_inactive_shares_pool_mut(v0);
        0x1::pool_u64_unbound::update_total_coins(v10, v3 - v5);
        let v11 = beneficiary_for_operator(0x1::stake::get_operator(arg0));
        buy_in_active_shares(v0, v11, v4);
        let v12 = beneficiary_for_operator(0x1::stake::get_operator(arg0));
        buy_in_pending_inactive_shares(v0, v12, v5);
        let v13 = 0x1::stake::get_operator(arg0);
        let v14 = DistributeCommissionEvent{
            pool_address                : arg0,
            operator                    : v13,
            commission_active           : v4,
            commission_pending_inactive : v5,
        };
        0x1::event::emit_event<DistributeCommissionEvent>(&mut v0.distribute_commission_events, v14);
        if (0x1::features::operator_beneficiary_change_enabled()) {
            let v15 = 0x1::stake::get_operator(arg0);
            let v16 = beneficiary_for_operator(0x1::stake::get_operator(arg0));
            let v17 = DistributeCommission{
                pool_address                : arg0,
                operator                    : v15,
                beneficiary                 : v16,
                commission_active           : v4,
            ...
            0x1::event::emit<DistributeCommission>(v17);
        };
        if (v1) {
            let (_, v19, _, _) = 0x1::stake::get_stake(arg0);
            v0.total_coins_inactive = v19;
            v0.observed_lockup_cycle.index = v0.observed_lockup_cycle.index + 1;
            let v22 = 0x1::pool_u64_unbound::create_with_scaling_factor(10000000000000000);
            0x1::table::add<ObservedLockupCycle, 0x1::pool_u64_unbound::Pool>(&mut v0.inactive_shares, v0.observed_lockup_cycle, v22);
        };
        if (is_next_commission_percentage_effective(arg0)) {
    ...
    fun unlock_internal(arg0: address, arg1: address, arg2: u64) acquires DelegationPool, GovernanceRecords {
        ...
        let v5 = pending_inactive_shares_pool(v4);
        let v6 = coins_to_transfer_to_ensure_min_stake(&v4.active_shares, v5, arg0, arg2);
