module 0x1::coin {
    ...
    public fun burn_from<T0>(arg0: address, arg1: u64, arg2: &BurnCapability<T0>) acquires CoinConversionMap, CoinInfo, CoinStore, PairedFungibleAssetRefs {
        ...
        if (v1 > 0) {
            let v5 = &mut borrow_global_mut<CoinStore<T0>>(arg0).coin;
            burn<T0>(extract<T0>(v5, v1), arg2);
        };
        if (v2 > 0) {
            let v6 = paired_metadata<T0>();
            assert!(0x1::option::is_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(&v6), 0x1::error::not_found(16));
            let v7 = 0x1::option::destroy_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(v6);
            let v8 = 0x1::object::object_address<0x1::fungible_asset::Metadata>(&v7);
            assert!(exists<PairedFungibleAssetRefs>(v8), 0x1::error::internal(19));
            let v9 = &mut borrow_global_mut<PairedFungibleAssetRefs>(v8).burn_ref_opt;
            assert!(0x1::option::is_some<0x1::fungible_asset::BurnRef>(v9), 0x1::error::not_found(25));
            let v10 = paired_metadata<T0>();
            let v11 = 0x1::primary_fungible_store::primary_store<0x1::fungible_asset::Metadata>(arg0, 0x1::option::destroy_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(v10));
            0x1::fungible_asset::burn_from<0x1::fungible_asset::FungibleStore>(0x1::option::borrow<0x1::fungible_asset::BurnRef>(v9), v11, v2);
        };
    }

    fun burn_internal<T0>(arg0: Coin<T0>) : u64 acquires CoinInfo {
        let Coin<T0> { value: v0 } = arg0;
        if (v0 != 0) {
    ...
    public fun deposit<T0>(arg0: address, arg1: Coin<T0>) acquires CoinConversionMap, CoinInfo, CoinStore {
        if (exists<CoinStore<T0>>(arg0)) {
            ...
            let v5 = if (0x1::option::is_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(&v4)) {
                let v6 = 0x1::option::destroy_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(v4);
                let v7 = 0x1::primary_fungible_store::primary_store_address<0x1::fungible_asset::Metadata>(arg0, v6);
                if (0x1::fungible_asset::store_exists(v7)) {
                    if (0x1::features::new_accounts_default_to_fa_apt_store_enabled()) {
                        true
                    } else {
                        exists<MigrationFlag>(v7)
                    }
                } else {
                    false
                }
            ...
            assert!(v5, 0x1::error::not_found(5));
            let v8 = coin_to_fungible_asset<T0>(arg1);
            0x1::primary_fungible_store::deposit(arg0, v8);
        };
    }
    ...
    public fun withdraw<T0>(arg0: &signer, arg1: u64) : Coin<T0> acquires CoinConversionMap, CoinInfo, CoinStore, PairedCoinType {
        ...
        if (v3 > 0) {
            ...
            let v12 = &mut v6;
            let v13 = fungible_asset_to_coin<T0>(0x1::primary_fungible_store::withdraw<0x1::fungible_asset::Metadata>(arg0, 0x1::option::destroy_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(v11), v3));
            merge<T0>(v12, v13);
        };
        v6
    }
    ...
    public(friend) fun collect_into_aggregatable_coin<T0>(arg0: address, arg1: u64, arg2: &mut AggregatableCoin<T0>) acquires CoinConversionMap, CoinInfo, CoinStore, PairedCoinType {
        ...
        let v5 = if (v1 > 0) {
            let v6 = &mut borrow_global_mut<CoinStore<T0>>(arg0).coin;
            extract<T0>(v6, v1)
        } else {
            zero<T0>()
        };
        if (v2 > 0) {
            ...
            let v9 = &mut v5;
            let v10 = fungible_asset_to_coin<T0>(v8);
            merge<T0>(v9, v10);
        };
    ...
    public(friend) fun ensure_paired_metadata<T0>() : 0x1::object::Object<0x1::fungible_asset::Metadata> acquires CoinConversionMap, CoinInfo {
        ...
        if (0x1::table::contains<0x1::type_info::TypeInfo, 0x1::object::Object<0x1::fungible_asset::Metadata>>(v2, v1)) {
            ...
            let v3 = 0x1::type_info::type_name<T0>() == 0x1::string::utf8(b"0x1::aptos_coin::AptosCoin");
            assert!(v3 && false || true, 0x1::error::invalid_state(28));
            let v4 = if (v3) {
                0x1::object::create_sticky_object_at_address(@0x1, @0xa)
            } else {
                let v5 = 0x1::create_signer::create_signer(@0xa);
    ...
    public(friend) fun force_deposit<T0>(arg0: address, arg1: Coin<T0>) acquires CoinConversionMap, CoinInfo, CoinStore {
        if (exists<CoinStore<T0>>(arg0)) {
            let v0 = &mut borrow_global_mut<CoinStore<T0>>(arg0).coin;
            merge<T0>(v0, arg1);
        } else {
            let v1 = paired_metadata<T0>();
            let v2 = if (0x1::option::is_some<0x1::object::Object<0x1::fungible_asset::Metadata>>(&v1)) {
                ...
                if (0x1::fungible_asset::store_exists(v4)) {
                    if (0x1::features::new_accounts_default_to_fa_apt_store_enabled()) {
                        true
                    } else {
                        exists<MigrationFlag>(v4)
                    }
                } else {
                    false
                }
            ...
            assert!(v2, 0x1::error::not_found(5));
            let v5 = coin_to_fungible_asset<T0>(arg1);
            let v6 = 0x1::fungible_asset::asset_metadata(&v5);
            let v7 = 0x1::primary_fungible_store::primary_store<0x1::fungible_asset::Metadata>(arg0, v6);
            let v8 = 0x1::object::object_address<0x1::fungible_asset::FungibleStore>(&v7);
            0x1::fungible_asset::deposit_internal(v8, v5);
        };
    }
