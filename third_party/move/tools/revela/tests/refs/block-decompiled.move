module 0x1::block {
    ...
    fun block_prologue_common(arg0: &signer, arg1: address, arg2: u64, arg3: u64, arg4: address, arg5: vector<u64>, arg6: vector<u8>, arg7: u64) : u64 acquires BlockResource, CommitHistory {
        ...
        let v6 = &mut v1.new_block_events;
        emit_new_block_event(arg0, v6, v3, v5);
    ...
    fun emit_genesis_block_event(arg0: signer) acquires BlockResource, CommitHistory {
        let v0 = &mut borrow_global_mut<BlockResource>(@0x1).new_block_events;
        ...
        emit_new_block_event(&arg0, v0, v3, v6);
    }
    ...
    public fun emit_writeset_block_event(arg0: &signer, arg1: address) acquires BlockResource, CommitHistory {
        ...
        let v1 = &mut v0.new_block_events;
        let v2 = 0x1::reconfiguration::current_epoch();
        let v3 = v0.height;
        let v4 = 0x1::vector::empty<u8>();
        let v5 = 0x1::vector::empty<u64>();
        let v6 = 0x1::timestamp::now_microseconds();
        let v7 = NewBlockEvent{
            hash                        : arg1,
            epoch                       : v2,
            ...
            proposer                    : @0x3001,
            failed_proposer_indices     : v5,
            time_microseconds           : v6,
        };
        let v8 = 0x1::reconfiguration::current_epoch();
        let v9 = v0.height;
        let v10 = 0x1::vector::empty<u8>();
        let v11 = 0x1::vector::empty<u64>();
        let v12 = 0x1::timestamp::now_microseconds();
        let v13 = NewBlock{
            hash                        : arg1,
            epoch                       : v8,
            round                       : 18446744073709551615,
            height                      : v9,
            previous_block_votes_bitvec : v10,
            proposer                    : @0x3001,
            failed_proposer_indices     : v11,
            time_microseconds           : v12,
        };
        emit_new_block_event(arg0, v1, v7, v13);
    }
